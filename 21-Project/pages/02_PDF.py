...
with st.sidebar:
    # 파일 업로드
    uploaded_file = st.file_uploader("PDF 파일 업로드", type=["pdf"]) # word 등도 등록 가능
...
# os.remove(".cache/files/")//을 활용해 업로드 된 내용을 삭제할 수 는 있지만 개발자가 해야함.